...
const Overlay: React.FC<OverlayProps> = ({ children }) => {
  return (
    <div className="fixed z-20 top-[23%] mx-4 sm:mx-0 left-[0%] xs:left-[13%] sm:left-[20%] md:left-[28%] lg:left-[40%]">
      {children}
    </div>
  );
};
...
const OverlayCard: React.FC<OverlayProps> = ({ children, onClose }) => {
